...
class Ui_AlgoIntroStep(object):
    def setupUi(self, AlgoIntroStep):
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 1451, 380))
    ...
    def retranslateUi(self, AlgoIntroStep):
        ...
        self.label_6.setText(QCoreApplication.translate("AlgoIntroStep", u"<html><head/><body><p>The YASA sleep scoring tool is compatible with different input files including, EDF, NATUS, and STS. </p><p>The output of the automatic scoring algorithm is a .tsv file that saves the predicted sleep stages. </p></body></html>", None))
    # retranslateUi
